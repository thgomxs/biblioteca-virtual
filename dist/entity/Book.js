...
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], Book.prototype, "url", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => Review_1.Review, (review) => review.book),
...
__decorate([
    (0, typeorm_1.ManyToMany)(() => User_1.User, (user) => user.reads),
    __metadata("design:type", Array)
], Book.prototype, "reads", void 0);
